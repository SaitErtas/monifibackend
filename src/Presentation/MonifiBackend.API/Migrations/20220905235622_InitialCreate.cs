        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Iso2 = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
                    Iso3 = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NativeName = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ChangePeriodDay = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaximumSalesQuantity = table.Column<long>(type: "bigint", nullable: false),
                    MaximumDistributedAPY = table.Column<long>(type: "bigint", nullable: false),
                    MaximumReferenceBonus = table.Column<long>(type: "bigint", nullable: false),
                    TotalPreSaleQuantity = table.Column<long>(type: "bigint", nullable: false),
                    MonifiPrice = table.Column<decimal>(type: "decimal(9,5)", precision: 9, scale: 5, nullable: false),
                    BscScanAddress = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    TronNetworkAddress = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    BscScanTokenSymbol = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    TronNetworkTokenSymbol = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ResetPasswordCode = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: true),
                    ReferanceUser = table.Column<int>(type: "int", maxLength: 250, nullable: false),
                    ReferanceCode = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: true),
                    ConfirmationCode = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequestName = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: false),
                    Status = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserId = table.Column<int>(type: "int", nullable: false),
                    CryptoNetworkId = table.Column<int>(type: "int", nullable: false),
                    WalletAddress = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: false),
                    Status = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
